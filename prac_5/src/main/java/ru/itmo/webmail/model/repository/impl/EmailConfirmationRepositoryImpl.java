...
public class EmailConfirmationRepositoryImpl implements EmailConfirmationRepository {
    ...
    public EmailConfirmation findByUserId(long userId) {
        try (Connection connection = DATA_SOURCE.getConnection()) {
            ...
            throw new RepositoryException("Can't find EmailConfirmation by id and passwordSha.", e);
        }
    }
    ...
    public EmailConfirmation findBySecret(String secret) {
        try (Connection connection = DATA_SOURCE.getConnection()) {
            ...
            throw new RepositoryException("Can't find EmaiConfirmation by id and passwordSha.", e);
        }
    }
